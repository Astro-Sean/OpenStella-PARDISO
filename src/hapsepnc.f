     ...
     *banabron2(1,1,1,1)),(hptabsc(1,1,1,1,2),hpbansc2(1,1,1,1))
      ...
      Fun(z,tabz1,tabz2,fun1,fun2)=fun1-(fun1-fun2)*((z-tabz1)/(tabz2-ta
     *bz1))
      xx=Log(Pl*Urho)
      yy=Log(Tp*Utp)
      xx=max(xx,RhoTab(1))
      ...
      j=Min0(14-1,j)
      DO09999L=1,NFREQ
      IF(.NOT.(abs(Knadap)==4.OR.abs(Knadap)==5))GOTO09996
      DO09993iis=1,2
...
09995 CONTINUE
      ...
      stop64
09994 CONTINUE
      if(hbal<0.d0.or.hbab<0.d0.or.hbal>1.d50.or.hbab>1.d50)then
      write(40,'(2(a,i4),1p,4(a,e12.4))')' kmhap=',kmhap,' L=',L,'  hbal
     *=',hbal,'  hbab=',hbab,'  Tp=',Tp,' pl=',pl
