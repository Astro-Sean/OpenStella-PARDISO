     ...
     *,0.030,0.000/
      ...
      DO09999i=1,NPTSU
      Lubv=NFREQ
09996 IF(.NOT.(Lubv>1.AND.FREQMN(Lubv)>CCL/WLU(i)))GOTO09995
      Lubv=Lubv-1
      GOTO09996
09995 CONTINUE
      indfreq(i,1)=Lubv
09999 CONTINUE
      DO09993i=1,NPTSB
      Lubv=NFREQ
09990 IF(.NOT.(Lubv>1.AND.FREQMN(Lubv)>CCL/WLB(i)))GOTO09989
      Lubv=Lubv-1
      GOTO09990
09989 CONTINUE
      indfreq(i,2)=Lubv
09993 CONTINUE
      DO09987i=1,NPTSV
      Lubv=NFREQ
09984 IF(.NOT.(Lubv>1.AND.FREQMN(Lubv)>CCL/WLV(i)))GOTO09983
      Lubv=Lubv-1
      GOTO09984
09983 CONTINUE
      indfreq(i,3)=Lubv
09987 CONTINUE
      DO09981i=1,NPTSR
      Lubv=NFREQ
09978 IF(.NOT.(Lubv>1.AND.FREQMN(Lubv)>CCL/WLR(i)))GOTO09977
      Lubv=Lubv-1
      GOTO09978
09977 CONTINUE
      indfreq(i,4)=Lubv
09981 CONTINUE
      DO09975i=1,NPTSI
      Lubv=NFREQ
09972 IF(.NOT.(Lubv>1.AND.FREQMN(Lubv)>CCL/WLI(i)))GOTO09971
      Lubv=Lubv-1
      GOTO09972
09971 CONTINUE
      indfreq(i,5)=Lubv
