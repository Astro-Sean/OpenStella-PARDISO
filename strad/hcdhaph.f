...
09990 CONTINUE
      ...
      hapHP(L)=(Tp1up4+Tp2up4)/((Tp2up4/hapLP2(L))*(1.d0+1.5d0*(exp(-tau
     *2(L))+tau2(L)-1.d0)*exp(-tau1(L)))+(Tp1up4/hapLP1(L))*(1.d0+1.5d0*
     *(exp(-tau1(L))+tau1(L)-1.d0)*exp(-tau2(L))))
09987 CONTINUE
...
09984 CONTINUE
      ...
      hapHM(L)=(Tp1up4+Tp2up4)/((Tp2up4/hapL2(L))*(1.d0+1.5d0*(exp(-tau2
     *(L))+tau2(L)-1.d0)*exp(-tau1(L)))+(Tp1up4/hapL1(L))*(1.d0+1.5d0*(e
     *xp(-tau1(L))+tau1(L)-1.d0)*exp(-tau2(L))))
